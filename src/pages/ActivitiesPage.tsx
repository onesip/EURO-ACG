...
import { Calendar as CalendarIcon, MapPin, Users, Plus, X } from 'lucide-react';
          ...
          return (
            <div key={activity.id} className="bg-[#141416] p-6 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-all group">
              <div className="flex justify-between items-start mb-3">
                <div className="inline-block px-3 py-1 bg-indigo-500/10 text-indigo-400 rounded-full text-xs font-semibold uppercase tracking-wider mb-2">
...
function CreateActivityModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#0A0A0B]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#141416] rounded-2xl border border-white/10 shadow-xl shadow-indigo-500/5 w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 bg-white/5 border border-white/10 text-white rounded-xl focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full px-3 py-2 bg-white/5 border border-white/10 text-white rounded-xl focus:ring-2 focus:ring-indigo-500/50 outline-none color-scheme-dark"
              />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full px-3 py-2 bg-white/5 border border-white/10 text-white rounded-xl focus:ring-2 focus:ring-indigo-500/50 outline-none resize-none mb-2"
            />
